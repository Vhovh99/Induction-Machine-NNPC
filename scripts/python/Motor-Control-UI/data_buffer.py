...
class TelemetryBuffer:
    ...
    def _init_lists(self):
        ...
        self.iq_I_term_values = []   # speed PI integrator output (A)
    ...
    def add_telemetry(self, id_val: float, iq_val: float, vbus: float,
        ...
        self.iq_I_term_values.append(iq_I_term)
    ...
    def get_plot_data(self) -> dict:
        ...
        return {
            ...
            'iq_I_term': np.array(self.iq_I_term_values),
        }
    ...
    def get_latest_values(self) -> dict:
        if len(self.timestamps) == 0:
            return {
                ...
                'theta_e': 0.0, 'torque_e': 0.0, 'imr': 0.0, 'dwr_dt': 0.0, 'iq_I_term': 0.0,
            }
        return {
            ...
            'iq_I_term': self.iq_I_term_values[-1],
        }
