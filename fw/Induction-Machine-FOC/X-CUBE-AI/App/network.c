...
#define AI_NETWORK_MODEL_SIGNATURE     "0x395179258515ab044785db4bab5e6111"
...
#define AI_TOOLS_DATE_TIME   "2026-03-16T23:24:48+0400"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 4, 4, 1, 1), AI_STRIDE_INIT(4, 4, 16, 64, 64),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 80);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 80);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 96);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 96);
    return true;
  }
